...
public:
    ...
    enum Place { PlaceHand, PlaceEquip, PlaceDelayedTrick, PlaceJudge, PlaceSpecial, DiscardPile, DrawPile, PlaceTable, PlaceUnknown, PlaceZiYuan };
...
public:
    ...
    void turnOver(const QString &skill_name = NULL);
