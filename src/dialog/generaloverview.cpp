...
void GeneralOverview::on_tableWidget_itemSelectionChanged() {
    ...
    if (general_name.contains("caocao")) {
	 ...
	 else if (general_name.contains("sunhao")) {
        QCommandLinkButton *win_button = new QCommandLinkButton(tr("Victory"),
                                                                tr("sunhaowin!"));
        ...
        win_button->setObjectName("audio/system/win-sunhao.ogg");
        connect(win_button, SIGNAL(clicked()), this, SLOT(playAudioEffect()));
    }
	 else if (general_name.contains("ncaorui")) {
        QCommandLinkButton *win_button = new QCommandLinkButton(tr("Victory"),
                                                                tr("ncaoruiwin!"));
        ...
        win_button->setObjectName("audio/system/win-ncaorui.ogg");
        connect(win_button, SIGNAL(clicked()), this, SLOT(playAudioEffect()));
    }
	 else if (general_name.contains("liuchen")) {
        QCommandLinkButton *win_button = new QCommandLinkButton(tr("Victory"),
                                                                tr("liuchenwin!"));
        ...
        win_button->setObjectName("audio/system/win-liuchen.ogg");
        connect(win_button, SIGNAL(clicked()), this, SLOT(playAudioEffect()));
    }
	 else if (general_name.contains("sunxiu")) {
        QCommandLinkButton *win_button = new QCommandLinkButton(tr("Victory"),
                                                                tr("sunxiuwin!"));
        ...
        win_button->setObjectName("audio/system/win-sunxiu.ogg");
        connect(win_button, SIGNAL(clicked()), this, SLOT(playAudioEffect()));
    }
