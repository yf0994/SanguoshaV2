...
Engine::Engine()
{
    ...
    modes["06_boss"] = tr("6 players (Boss)");
...
QStringList Engine::getRandomGenerals(int count, const QSet<QString> &ban_set/* = QSet<QString>()*/, const QString &kingdom/* = QString()*/) const{
    ...
    if (ServerInfo.GameMode == "06_boss")
        general_set = general_set.subtract(Config.value("Banlist/06_boss", "").toStringList().toSet());
...
QList<int> Engine::getRandomCards() const{
	...
	if (Config.value("exchange_god", true).toBool()) {
        list.removeOne(56);
        list.removeOne(57);
        list.removeOne(60);
        list.removeOne(62);
