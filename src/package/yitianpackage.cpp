...
// ---------- Lianli related skills// ---------- Lianli related skills
/*
...
class Zonghuo: public FilterSkill {
public:
    Zonghuo(): FilterSkill("zonghuo") {
    }
    ...
    virtual const Card *viewAs(const Card *originalCard) const{
        Slash *slash = new FireSlash(originalCard->getSuit(), originalCard->getNumber());
